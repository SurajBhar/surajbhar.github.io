...
AI discussions often reduce everything to a single ingredient: _the model_.  
...
The table helps you ask: _Which ingredients do we need to achieve a specific product outcome under constraints (latency, cost, security, compliance)?_
